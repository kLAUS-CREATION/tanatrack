...
/**
 * Shared shell for list pages under /organizations/[orgId]. Renders a
 * consistent header (title + subtitle + actions) and a body that switches
 * between a full-page skeleton, a full-page empty state, and the real content
 * — so loading and zero-data look identical across every page.
 */
