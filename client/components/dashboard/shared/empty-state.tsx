...
/**
 * Full-page "no data" state, shared by every list page under
 * /organizations/[orgId] so the zero-state looks identical everywhere.
 * Grows to fill the available content height rather than sitting in a
